...
def create_gui():
    ...
    def create_circle_button(canvas, x, y, r, color, text, button_name):
        ...
        # Add button text
        label = canvas.create_text(x, y, text=text, font=font, fill="black")
    ...
    canvas = tk.Canvas(root, width=380, height=450, bg='white')
    canvas.pack()
    ...
    create_circle_button(canvas, x=100, y=150, r=40, color="yellow", text="B0", button_name='B0')
    create_circle_button(canvas, x=100, y=250, r=40, color="yellow", text="B1", button_name='B1')
    create_circle_button(canvas, x=100, y=350, r=40, color="yellow", text="B2", button_name='B2')

    # Create digital buttons (D3, D4, D5) as circles
    create_circle_button(canvas, x=250, y=150, r=40, color="cyan", text="D3", button_name='D3')
    create_circle_button(canvas, x=250, y=250, r=40, color="cyan", text="D4", button_name='D4')
    create_circle_button(canvas, x=250, y=350, r=40, color="cyan", text="D5", button_name='D5')
